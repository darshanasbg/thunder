...
CREATE TABLE LAYOUT (
    ...
    CREATED_AT TIMESTAMPTZ DEFAULT NOW(),
    UPDATED_AT TIMESTAMPTZ DEFAULT NOW(),
    UNIQUE (LAYOUT_ID, DEPLOYMENT_ID)
);
...
CREATE TABLE APPLICATION (
    ...
    FOREIGN KEY (THEME_ID, DEPLOYMENT_ID) REFERENCES THEME(THEME_ID, DEPLOYMENT_ID) ON DELETE RESTRICT,
...
CREATE TABLE RESOURCE (
    ...
    FOREIGN KEY (RESOURCE_SERVER_ID, DEPLOYMENT_ID)
        REFERENCES RESOURCE_SERVER(RESOURCE_SERVER_ID, DEPLOYMENT_ID)
        ON DELETE RESTRICT
        ON UPDATE CASCADE,
    FOREIGN KEY (PARENT_RESOURCE_ID, DEPLOYMENT_ID)
        REFERENCES RESOURCE(RESOURCE_ID, DEPLOYMENT_ID)
        ON DELETE RESTRICT
        ON UPDATE CASCADE
);
